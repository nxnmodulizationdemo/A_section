...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/nxnmodulizationdemo/A_section"
  ...
  s.author             = { "" => "" }
  # Or just: s.author    = "nxnmodulizationdemo"
  # s.authors            = { "nxnmodulizationdemo" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/nxnmodulizationdemo"
  ...
  s.source       = { :git => "https://github.com/nxnmodulizationdemo/A_section.git", :tag => "#{s.version}"  }
